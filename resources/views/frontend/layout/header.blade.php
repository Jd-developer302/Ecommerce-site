    ...
    <div class="container">
        ...
        <div class="navbar">
            <div class="data">
                ...
                <a href="{{ route('about.us') }}" id="text-uppercase" style="text-decoration: none;">About Us</a>
                <a href="{{ route('shop') }}" id="text-uppercase" style="text-decoration: none;">Shop</a>
                <a href="{{ route('contact') }}" id="text-uppercase" style="text-decoration: none;">Contact Us</a>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content ">
                        ...
                        <div class="row">
                            ...
                            @endphp
                            @foreach ($categories->chunk($chunkSize) as $chunk)
                                <div class="column">
                                    @foreach ($chunk as $category)
                                        <a class="side-menu__item"
                                            href="{{ route('cat.view', ['id' => encryptNumber($category->id)]) }}"
                                            style="text-decoration: none; color: #333; ">
                                            <i class="fa-solid fa-caret-right"></i> {{ $category->name }}
                                        </a>
                                    @endforeach
                                </div>
                            @endforeach
                            <div class="mega-menu-image">
                                <img src="{{ URL::asset('front/img/leptop.png') }}" alt="logo"
            ...
            <div class="log">
                ...
                <div class="cart">
                    <a href="{{ route('cart.list') }}">
                        ...
                        <h5 id="cart-count">{{ count(session('tempcart', [])) }}</h5>
                    </a>
                </div>
